...
bool Game::Initialize()
{
	...
	mBallPos.x = 1024.0f / 2.0f;//posição da bola 1 eixo x
	mBallPos.y = 768.0f / 2.0f;//posição da bola 1 eixo y
	...
	mBallPos2.x = 1000.0f / 2.0f;//posição da bola 2 eixo x
	mBallPos2.y = 800.0f / 2.0f;//posição da bola 2 eixo y
...
void Game::UpdateGame()
{
	...
	{
		//Paliativo para não terminar o jogo.
		mBallVel.x *= -1.0f;
		//mIsRunning = false;
	}
	...
	//Verifica se a bola 2 saiu da tela (no lado esquerdo, onde é permitido)
	//Se sim, encerra o jogo
	// Did the ball go off the screen? (if so, end game)
	else if (mBallPos2.x <= 0.0f || mBallPos2.x <= 0.0f)
	{
		//Paliativo para não terminar o jogo.
		mBallVel2.x *= -1.0f;
		//mIsRunning = false;
	...
	//Atulize a velocidade da bola 2 se ela colidir com a parede do lado direito
	// Did the ball collide with the right wall?
	...
	//Atualize a posição da bola 2 se ela colidir com a parede de cima
	// Did the ball collide with the top wall?
	...
	//Atualize a posição da bola 2 se ela colidiu com a parede de baixo
	// Did the ball collide with the bottom wall?
